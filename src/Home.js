...
import slider1 from './img/slide_logo_1.webp'
    ...
    <div className="home">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div className="icon_free">
            <div className="blk_icon"><div><AddShoppingCartIcon className="inner_icon"/></div><div className="text_as">Cửa hàng của FORIA</div></div>
            <div className="blk_icon"><div><LocalShippingIcon className="inner_icon"/></div><div className="text_as">Free Shipping</div></div>
            <div className="blk_icon"><div><DiscountIcon className="inner_icon"/></div><div className="text_as">Cashback mỗi ngày</div></div>
            <div className="blk_icon"><div><PriceChangeIcon className="inner_icon"/></div><div className="text_as">Vouchers mỗi ngày</div></div>
            <div className="blk_icon ic1"><div><TravelExploreIcon className="inner_icon"/></div><div className="text_as">Đặt hàng quốc tế</div></div>
            <div className="blk_icon ic1"><div><LocalMallIcon className="inner_icon"/></div><div className="text_as">Authentic Brand</div></div>
            <div className="blk_icon ic1"><div><CurrencyExchangeIcon className="inner_icon"/></div><div className="text_as">Coin phần thưởng</div></div>
            <div className="blk_icon ic1"><div><HandshakeIcon className="inner_icon"/></div><div className="text_as">Blank Promotion</div></div>
            <div className="blk_icon ic1"><div><FiberNewIcon className="inner_icon"/></div><div className="text_as">Sales mỗi ngày</div></div>
        </div>
      </div>
     {/* Carousel */}
        <div class="container">
          <div class="row g-5">
            <div class="col-4">
              ...
              <div  class="p-4 border hover01 box">
                ...
                <h2>Đĩa than (VINYL)</h2><p>10k+ sản phẩm</p>
              </div>
              </a>
            </div>
            <div class="col-4">
            <a href="https://rad-platypus-c6f7c3.netlify.app/">
              <div class="p-4 border  box1"><h2>CD + DVD</h2><p>10k+ sản phẩm</p></div>
              </a>
            </div>

            <div class="col-4">
            <a href="https://rad-platypus-c6f7c3.netlify.app/">
              <div class="p-4 border  box2"><h2>Cassette</h2><p>10k+ sản phẩm</p></div>
              </a>
            </div>

            <div class="col-4">
            <a href="https://rad-platypus-c6f7c3.netlify.app/">
              <div class="p-4 border  box3"><h2>Album</h2><p>10k+ sản phẩm</p></div>
              </a>
            </div>

            <div class="col-4">
            <a href="https://rad-platypus-c6f7c3.netlify.app/">
              <div class="p-4 border  box4"><h2>Ấn phẩm có chữ kí</h2><p>10k+ sản phẩm</p></div>
              </a>
            </div>
            
            <div class="col-4">
            <a href="https://rad-platypus-c6f7c3.netlify.app/">
              <div class="p-4 border  box5"><h2>Sách</h2><p>10k+ sản phẩm</p></div>
              </a>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-15">
              <div class="carousel carousel-showmanymoveone slide" id="itemslider">
                <div class="carousel-inner">
                  ...
                  <div class="item">
                    <div class="col-xs-6 col-sm-6 col-md-2">
                      <Product
                        ...
                        origin = {1200}
                      />
                      <span className="badge"><h4>Sold</h4></span>
                    </div>
                  </div>
                  ...
                  <div class="item">
                    <div class="col-xs-6 col-sm-6 col-md-2">
                      <span className="badge"><div className="discount">10%</div></span>
                      <Product
                        image={HaAnhTuan}
                        id="12321346"
                ...
                <a class="left carousel-control" href="#itemslider" data-slide="prev"><img src="https://cdn1.iconfinder.com/data/icons/general-ui-outlined-thick/24/chevron-left-512.png" alt="Left" class="img-responsive" /></a>
                <a class="right carousel-control" href="#itemslider" data-slide="next"><img src="https://cdn4.iconfinder.com/data/icons/navigation-40/24/chevron-right-512.png" alt="Right" class="img-responsive"/></a>
              </div>
              </div>
            </div>
          </div>
...
{/* <!-- Item slider end--> */}
            ...
            <div className="spmoi">
            <Tabs defaultActiveKey="home" id="uncontrolled-tab-example" className="mb-3 haiz">
